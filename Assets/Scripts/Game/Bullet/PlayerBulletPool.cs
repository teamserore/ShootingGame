...
public class PlayerBulletPool : MonoBehaviour {
    ...
    IEnumerator Start() {
        ...
        playerBulletprefab[1] = Resources.Load("Prefabs/PlayerBullet2") as GameObject;
        playerBulletprefab[2] = Resources.Load("Prefabs/PlayerBullet3") as GameObject;
        playerBulletprefab[3] = Resources.Load("Prefabs/PlayerBullet4") as GameObject;
        playerBulletprefab[4] = Resources.Load("Prefabs/PlayerBullet5") as GameObject;
        playerBulletprefab[5] = Resources.Load("Prefabs/PlayerBullet6") as GameObject;
        playerBulletprefab[6] = Resources.Load("Prefabs/PlayerBullet7") as GameObject;
        playerBulletprefab[7] = Resources.Load("Prefabs/PlayerBullet8") as GameObject;
        playerBulletprefab[8] = Resources.Load("Prefabs/PlayerBullet9") as GameObject;
        playerBulletprefab[9] = Resources.Load("Prefabs/PlayerBullet10") as GameObject;
     ...
     //   currentPowerLV--;
        ...
        for (int i = 0; i < 12 - currentPowerLV; i++) {
            ...
            for (int j = 0; j < maxPlayerBullet; j++) {
                GameObject playerBullet = (GameObject)Instantiate(playerBulletprefab[i + currentPowerLV - 1]); // Create bullet prefab
    ...
    public int CheckPowerLv(int pw) {
        if (pw == 10) { return 1; }
        else if (pw == 14) { return 2; }
        else if (pw == 18) { return 3; }
        else if (pw == 22) { return 4; }
        else if (pw == 26) { return 5; }
        else if (pw == 30) { return 6; }
        else if (pw == 34) { return 7; }
        else if (pw == 38) { return 8; }
        else if (pw == 42) { return 9; }
        else if (pw == 46) { return 10; }
        else if (pw == 200) { return 11; }
        else {
